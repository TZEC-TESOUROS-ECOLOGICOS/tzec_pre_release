    ...
    <section id="beneficios">
      <div className="beneficios-content">
        ...
        <div className="beneficio-container">
          <Beneficio
            icon={<CheckAll size={26} />}
            title="Autenticidade Maranhense"
            description="Cada mordida é uma exploração do sabor da região - uma jornada de sabores autênticos que encantam seu paladar."
          />

          <Beneficio
            icon={<Recycle size={26} />}
            title="Sustentabilidade"
            description="Nosso compromisso também é com o planeta! Nossos produtos refletem a beleza maranhense e a beleza da sustentabilidade."
          />
